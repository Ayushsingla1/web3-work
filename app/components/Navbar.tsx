  ...
  return (
    <div className="bg-[#6581A6] w-full p-4 md:p-6 flex flex-wrap justify-between items-center">
      ...
      <div className="hidden md:flex space-x-4">
        <Link
          href="/"
          className="text-white hover:text-gray-300 pt-3 md:pt-10 font-['Hammersmith_One'] text-[20px] md:text-[23px]"
        >
          home
        </Link>
        <Link
      ...
      {isMenuOpen && (
        <div className="md:hidden flex flex-col space-y-4 mt-4 w-full">
          <Link
            href="/"
            className="text-white hover:text-gray-300 pt-2 font-['Hammersmith_One'] text-[20px]"
          >
            home
          </Link>
          <Link
        ...
        {isLoggedIn ? (
          <>
            <button
              ...
              className="text-[#BDD9F2] hover:text-gray-300 font-['Hammersmith_One'] text-[18px] md:text-[20px]"
            >
              SignOut
            </button>
            <Link href="/profile">
              <button className="text-[#BDD9F2] hover:text-gray-300 font-['Hammersmith_One'] text-[18px] md:text-[20px]">
                Profile
              </button>
            </Link>
          </>
