...
export const ContextProvider = ({children} : { children: React.ReactNode }) => {
  ...
  const [escrowAddress, setEscrowAdress] = useState<string>("");
    ...
    return(
        <MyContext.Provider value={{googleAuth,findUser,createUserWithEmail,signInWithEmail,githubAuth , getProfile , updateProfile , createPost, getposts , getFreeLancers, getProfileByUsername, showContractDropDown, setShowContractDropDown, escrowAddress, setEscrowAdress}}>
            {children}
        </MyContext.Provider>
    )
}