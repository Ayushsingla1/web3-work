          ...
          <form className="space-y-6 flex-grow mt-8">
            <div className="space-y-6">
              <div>
                ...
                <input type="text" id="name" name="name" className="w-full px-3 py-2 mt-1 bg-gray-800 border border-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 bg-[#D7E4F0]" />
              </div>
              <div>
